    ...
    : QMainWindow(parent)
{
    ...
    l->move(100,50);
    QPixmap p("C:/Users/POOJA/Documents/SimpleLoginForm/images/login.png");
    l->setPixmap(p.scaled(20,20));

    QLabel *lb=new QLabel(this);
    lb->move(180,25);
    lb->setAlignment(Qt::AlignHCenter);
    QPixmap pi("C:/Users/POOJA/Documents/SimpleLoginForm/images/username.png");
    ...
    QPixmap pix("C:/Users/POOJA/Documents/SimpleLoginForm/images/password.png");
